...
print(np.array(question_list_good)[ll_ranking_list[:100]])

with open('/Mistral22_baseline/question_top100_mistral22b.csv','w') as f:
    for k in range(100):
